...
// 并且必须是系统应用该方法才有效
     ...
     * 打开指定包名的App
     */
    public static void openOtherApp(String packageName,Activity activity){
     ...
     * 打开指定包名的App应用信息界面
     */
    public static void showAppInfo(String packageName,Activity activity) {
        Intent intent = new Intent();
     ...
     * 分享Apk信息
     */
    public static void shareApkInfo(String info,Activity activity) {
        Intent intent = new Intent();
